...
Icon.Image = "rbxassetid://100375298524189"
    ...
    function self:create_tab(title: string, icon: string)
        ...
        Tab.TextColor3 = Color3.fromRGB(255, 183, 197)
        ...
        TextLabel.TextColor3 = Color3.fromRGB(255, 183, 197)
...
function TabManager:moduleparagraph(settings: any)
    ...
    ModuleName.TextColor3 = Color3.fromRGB(255, 183, 197)
    ...
    ImageCorner.Parent = Image
        ...
        function TabManager:create_module(settings: any)
            ...
            function ModuleManager:create_checkbox(settings: any)
                ...
                TitleLabel.TextColor3 = Color3.fromRGB(255, 183, 197)
    ...
    return Button
            ...
            function ModuleManager:create_divider(settings: any)
                ...
                if settings and settings.showtopic then
                    local TextLabel = Instance.new('TextLabel')
                    TextLabel.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.SemiBold, Enum.FontStyle.Normal)
                    TextLabel.TextColor3 = Color3.fromRGB(255, 183, 197) -- 154, 182, 255
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Value.TextColor3 = Color3.fromRGB(255, 183, 197)
            ...
            function ModuleManager:create_dropdown(settings: any)
                ...
                CurrentOption.TextColor3 = Color3.fromRGB(255, 183, 197)
                ...
                if #settings.options > 0 then
                    ...
                    for index, value in settings.options do
                        ...
                        Option.TextColor3 = Color3.fromRGB(255, 183, 197)
            ...
            function ModuleManager:create_feature(settings)
                ...
                FeatureButton.TextColor3 = Color3.fromRGB(255, 183, 197)
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(255, 250, 250)
                KeybindBox.TextColor3 = Color3.fromRGB(255, 183, 197)
...
local AvatarTab = library:create_tab("Avatar", "rbxassetid://126017907477623")
local SettingTab = library:create_tab("Setting", "rbxassetid://6031280882")
                        ...
                        autoparry_mobile.button.InputEnded:Connect(function(input)
                            if input.UserInputType == Enum.UserInputType.Touch and not was_dragged then
                                ...
                                if System and System.__properties and System.__properties.__autoparry_enabled then
                                    ...
                                    autoparry_mobile.text.TextColor3 = Color3.fromRGB(255, 183, 197)
                                else
...
local function create_mobile_button(name, position_y, color)
    ...
    text.TextSize = 16
    text.TextColor3 = Color3.fromRGB(255, 183, 197)
    text.ZIndex = 3
    text.Parent = button
...
manual_spam_module:create_module({
    title = 'Auto Spam',
...
local avatar_module = AvatarTab:create_module({
    title = '',
    flag = 'AvatarChanger',
...
local no_render_module = SettingTab:create_module({
    title = "",
    ...
    callback = function(state)
        ...
        if state then
            Connections_Manager[''] = workspace.Runtime.ChildAdded:Connect(function(Value)
                Debris:AddItem(Value, 0)
            end)
        else
            if Connections_Manager[''] then
                Connections_Manager['']:Disconnect()
                Connections_Manager[''] = nil
            end
        end
    end
})
...
-- Added global styling placeholder
